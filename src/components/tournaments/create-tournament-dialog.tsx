...
export function CreateTournamentDialog({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto glass-card border-cyan-border">
        <DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                readOnly
                className="w-full px-4 py-2 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-lg opacity-60 text-[var(--text-primary)]"
              />
              <p className="text-xs text-[var(--text-secondary)] mt-1">
